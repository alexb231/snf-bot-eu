...
pub fn should_buy_beer(_character_equip: &Equipment, amount_of_beers_to_drink: u8, amount_of_beers_drunk: u8, amount_of_beers_max: u8, current_thirst: u32, current_mushroom_amount: u32, shrooms_to_keep: u32) -> bool
{
