...
const translations = {
    en: {
        ...
        "coupon.button": "Redeem coupon",
        "coupon.title": "Redeem Coupon",
        "coupon.code": "Coupon code",
        "coupon.redeem": "Redeem for all",
        "coupon.cancel": "Cancel",
        "coupon.empty": "Please enter a coupon code",
        "coupon.redeeming": "Redeeming coupon...",
        "coupon.error": "Coupon redeem failed:",
        "coupon.background": "Redeeming coupons in background...",
        "coupon.summary": "Coupon result: {applied}/{total} applied, {failed} failed",
        "coupon.rateLimitSummary": "Rate limit hit for {count} character(s)",
        "coupon.moreFailures": "{count} more failures...",
        "coupon.started": "Coupon run started",
        "coupon.running": "Coupon run already running",
        "coupon.toastSuccess": "All coupons redeemed",
        "coupon.toastDone": "Coupon run finished: {applied}/{total} applied",
    ...
    de: {
        ...
        "coupon.button": "Coupon einloesen",
        "coupon.title": "Coupon einloesen",
        "coupon.code": "Coupon Code",
        "coupon.redeem": "Fuer alle einloesen",
        "coupon.cancel": "Abbrechen",
        "coupon.empty": "Bitte Coupon Code eingeben",
        "coupon.redeeming": "Coupon wird eingeloest...",
        "coupon.error": "Coupon Einloesen fehlgeschlagen:",
        "coupon.background": "Coupon Einloesung laeuft im Hintergrund...",
        "coupon.summary": "Coupon Ergebnis: {applied}/{total} eingeloest, {failed} fehlgeschlagen",
        "coupon.rateLimitSummary": "Rate limit bei {count} Charakter(en)",
        "coupon.moreFailures": "{count} weitere Fehler...",
        "coupon.started": "Coupon Lauf gestartet",
        "coupon.running": "Coupon Lauf laeuft bereits",
        "coupon.toastSuccess": "Alle Coupons eingelöst",
        "coupon.toastDone": "Coupon Lauf fertig: {applied}/{total} eingeloest",
